...
### Requirement: REQ-MEM-004 SHALL seleccionar subordinado mediante query param ?empId= en Asignación de Objetivos

The system SHALL initialize `selectedEmployeeId` from `?empId=` for evaluators.
...
### Requirement: REQ-MEM-005 SHALL mostrar columna de estado y botón Metas en tabla de Mis Evaluados

The system SHALL show status badge and Metas button per phase.
...
### Requirement: REQ-MEM-006 SHALL proveer ruta dedicada /mis-evaluados/[id]/metas

The system SHALL provide `/mis-evaluados/[id]/metas` with categories, goals and return navigation.
