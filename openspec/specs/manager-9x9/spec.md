...
Cada jefe/director/gerente SHALL ver su propia matriz 9×9 con sus evaluatees. No SHALL ver la matriz de otros evaluadores.

#### Scenario: Jefe ve su matriz

- GIVEN jefe "Carlos" con 5 evaluatees
...
#### Scenario: Director ve su matriz

- GIVEN director con 3 jefes como evaluatees
- WHEN accede a la matriz 9×9
- THEN ve los 3 jefes (no los colaboradores de esos jefes)
- AND su matriz es independiente de la del jefe

#### Scenario: Colaborador sin matriz
