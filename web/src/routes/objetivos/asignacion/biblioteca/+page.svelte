	...
	<div class="space-y-6 max-w-full min-w-0">
		...
		<div>
			...
			<p class="text-sm text-base-content/50 mt-1">
				Gestione los indicadores clave de desempeño reutilizables para vincular
				a metas.
			</p>
		</div>
								...
								<tr>
									...
									<td>
										<CustomSelect
											...
											value={editDirection}
											onChange={(v) =>
												(editDirection = v as 'ascendente' | 'descendente')}
											ariaLabel="Dirección"
										/>
									</td>
									<td>
					...
					<div class="grid grid-cols-1 md:grid-cols-3 gap-3">
						...
						<div class="form-control">
							...
							<CustomSelect
								...
								onChange={(v) =>
									(addFormDirection = v as 'ascendente' | 'descendente')}
								ariaLabel="Dirección"
							/>
						</div>
						...
						<div class="form-control">
							<label class="label" for="add-kpi-target">
								...
								<span class="label-text-alt text-base-content/30 text-xs"
									>Opcional</span
								>
							</label>
							<input
...
<dialog class="modal" class:modal-open={deleteTargetId !== null}>
	<div class="modal-box">
		...
		<p class="py-4">
			¿Está seguro que desea eliminar el KPI <strong>{deleteTargetName}</strong
