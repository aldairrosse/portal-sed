		...
		requisitos: [
			{
				...
				notas:
					'Responsive: lg:drawer-open. El menú cambia según el perfil de usuario seleccionado en la barra dev.',
			},
			{
				id: 2,
				seccion: '1. Inicio — Shell de la aplicación',
				...
				notas:
					'Soporta 9 perfiles: colaborador, jefe, vendedor, gerente-tienda, divisional, regional, director, director-general, rh.',
			},
			{
				id: 3,
				seccion: '1. Inicio — Shell de la aplicación',
				...
				notas:
					'Al cambiar el perfil, toda la app se comporta como si ese usuario hubiera iniciado sesión. Datos mock, sin autenticación real.',
			},
			{
				id: 4,
				seccion: '1. Inicio — Shell de la aplicación',
				...
				notas:
					'Los logos en la barra lateral también se adaptan al tema (logo_black.png para tema claro, logo_white.png para oscuro).',
			},
			{
				id: 5,
				seccion: '1. Inicio — Shell de la aplicación',
			...
			},
			{
				...
				notas:
					'El perfil "colaborador" usa "María López García". Los datos se consumen desde archivos JSON en src/lib/fixtures/.',
			},
		],
	},
	{
		...
		requisitos: [
			{
				...
				notas:
					'Las categorías de metas son independientes de los pilares de competencias. Cada usuario define las suyas.',
			},
			{
				id: 8,
				seccion: '2. Metas — Asignación de inicio de año',
				...
				notas:
					'Todas las metas tienen unidad (%, $ o numérico) y un peso que suma 100% dentro de su categoría.',
			},
			{
				id: 9,
				seccion: '2. Metas — Asignación de inicio de año',
				...
				notas:
					'No se puede guardar si no suma 100% en ambos niveles. Es una regla de negocio obligatoria.',
			},
			{
				id: 10,
				seccion: '2. Metas — Asignación de inicio de año',
				...
				notas:
					'El jefe NO puede borrar ni agregar metas, solo solicitar cambios. El dueño de la meta decide si acepta.',
			},
			{
				id: 11,
				seccion: '2. Metas — Asignación de inicio de año',
				requerimiento:
					'Biblioteca de KPIs: catálogo de indicadores predefinidos que se pueden asignar a las metas.',
				entregables: [
					{
				...
				notas:
					'KPIs pueden ser numéricos, porcentaje o moneda. Un KPI puede vincularse a una o más metas.',
			},
			{
				id: 12,
				seccion: '2. Metas — Asignación de inicio de año',
				...
				notas:
					'El jefe selecciona un colaborador en el picker, ve sus metas en solo lectura y puede solicitar cambios. Sus propias metas aparecen con "(Yo)". Usa org-tree.json para la jerarquía.',
			},
		],
	},
	{
		...
		requisitos: [
			{
				...
				seccion: '3. Metas — Avance de medio año',
				requerimiento:
					'Edición de metas existentes en la fase de medio año: actualizar valor esperado y registrar avance real.',
				entregables: [
					{
				...
				notas:
					'En medio año NO se pueden eliminar metas, solo ajustar campos permitidos y registrar avances.',
			},
			{
				id: 14,
				seccion: '3. Metas — Avance de medio año',
				requerimiento:
					'Registro de avance porcentual o por valor para cada meta.',
				entregables: [
					{
		...
		requisitos: [
			{
				...
				notas:
					'La escala es 1-5 con criterios específicos que cambian según el perfil de evaluación.',
			},
			{
				id: 16,
				seccion: '4. Mi evaluación — Autoevaluación de fin de año',
				requerimiento:
					'Visualización en gráfico radar de las competencias evaluadas.',
				entregables: [
					{
				...
				notas:
					'Usa Chart.js con radar controller. Los colores se adaptan automáticamente al tema activo.',
			},
			{
				id: 17,
				seccion: '4. Mi evaluación — Autoevaluación de fin de año',
				requerimiento:
					'Cierre de metas: registrar cumplimiento final de cada meta.',
				entregables: [
					{
				...
				notas:
					'El cierre de metas ocurre en la fase de fin de año, junto con la autoevaluación de competencias.',
			},
			{
				id: 18,
				seccion: '4. Mi evaluación — Autoevaluación de fin de año',
				...
				notas:
					'Exporta los datos visibles en la tabla sin formato Niños/pesos.',
			},
		],
	},
	{
		...
		requisitos: [
			{
				...
				notas:
					'TODOS los perfiles usan el mismo catálogo de pilares. Es único para toda la empresa.',
			},
			{
				id: 20,
				seccion: '5. Administración RH — Competencias',
			...
			},
			{
				...
				notas:
					'La escala 1-5 es fija, pero los criterios descriptivos cambian por perfil (ej. lo que significa "3" para un vendedor vs un director).',
			},
			{
				id: 22,
				seccion: '5. Administración RH — Competencias',
				...
				notas:
					'Cada perfil de evaluación tiene sus propios niveles de aceptación.',
			},
		],
	},
	{
		...
		requisitos: [
			{
				...
				notas:
					'RH puede ver el detalle de cada evaluación y comparar resultados.',
			},
			{
				id: 24,
				seccion: '6. Evaluación RH — Fin de año',
				requerimiento:
					'Comparación entre autoevaluación del empleado y evaluación de RH.',
				entregables: [
					{
						item: 'ComparisonTable para mostrar lado a lado la calificación del empleado vs la de RH.',
						archivos: [
							'web/src/lib/components/evaluation/ComparisonTable.svelte',
						],
					},
				],
				notas:
					'Útil para detectar brechas entre cómo se ve el empleado y cómo lo ve RH.',
			},
		],
	},
	{
		...
		requisitos: [
			{
				...
				notas:
					'NO reemplaza la evaluación RH de competencias. El 9×9 es SOLO para potencial/desempeño.',
			},
			{
				id: 26,
				seccion: '7. Matriz 9×9 — Evaluación de jefes',
				requerimiento:
					'Árbol de jerarquía organizacional para navegar entre colaboradores.',
				entregables: [
					{
				...
				notas:
					'Jerarquía dual: corporativa (colaborador→jefe→director→director general) y retail (vendedor→gerente tienda→divisional→regional).',
			},
			{
				id: 27,
				seccion: '7. Matriz 9×9 — Evaluación de jefes',
				...
				notas:
					'El jefe puede ver las competencias de su colaborador pero no calificarlas (eso lo hace RH).',
			},
		],
	},
	{
		...
		requisitos: [
			{
				...
				notas:
					'El alcance de "mis evaluados" depende del perfil: un jefe ve a sus colaboradores directos; un director ve a todos los de su área.',
			},
		],
	},
	{
		...
		requisitos: [
			{
				...
				notas:
					'El cierre de sesión es simulado (no hay auth real). La actividad se filtra por perfil.',
			},
		],
	},
	{
		...
		requisitos: [
			{
				...
				seccion: '10. Backend — Infraestructura (en progreso)',
				requerimiento:
					'Servidor HTTP en Go con router Chi listo para servir APIs REST.',
				entregables: [
					{
				...
				notas:
					'Usa Chi como router, Ent como ORM. Las migraciones se ejecutan automáticamente al iniciar.',
			},
			{
				id: 31,
				seccion: '10. Backend — Infraestructura (en progreso)',
				...
				notas:
					'Usuario no-root en Docker. Variables de entorno para configuración.',
			},
			{
				id: 32,
				seccion: '10. Backend — Infraestructura (en progreso)',
				requerimiento:
					'Seeders con datos iniciales que coinciden con los fixtures del frontend.',
				entregables: [
					{
				...
				notas:
					'Los seeders replican los datos de web/src/lib/fixtures/ para que frontend y backend usen la misma información.',
			},
			{
				id: 33,
				seccion: '10. Backend — Infraestructura (en progreso)',
				requerimiento:
					'Pruebas de integración que verifican que todas las rutas responden sin error 500.',
				entregables: [
					{
				...
				notas:
					'Requiere Docker para la base de datos de prueba. Incluye verificación de endpoints CRUD principales.',
			},
		],
	},
];
