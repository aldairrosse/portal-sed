...
<div class="border border-base-300 rounded-lg p-4 bg-base-200/50 w-full">
	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
		<div class="form-control">
			<label class="label" for="goal-name"
				><span class="label-text text-xs">Nombre de meta u objetivo</span
				></label
			>
			<input
				id="goal-name"
		...
		<div class="form-control">
			<label class="label" for="goal-desc"
				><span class="label-text text-xs">Descripci&oacute;n a realizar</span
				></label
			>
			<textarea
				id="goal-desc"
		...
		<div class="form-control">
			<label class="label" for="goal-weight"
				><span class="label-text text-xs">Ponderaci&oacute;n (%)</span></label
			>
			<input
				id="goal-weight"
				type="number"
		...
		<div class="form-control">
			<p class="label">
				<span class="label-text text-xs">Direcci&oacute;n del objetivo</span>
			</p>
		...
		{#if direction === 'descendente'}
			<div class="form-control">
				<label class="label" for="goal-baseline"
					><span class="label-text text-xs">Punto de partida actual</span
					></label
				>
				<input
					id="goal-baseline"
	...
	{#if allKpis.length > 0}
		<div class="form-control mb-3">
			<span class="label"
				><span class="label-text text-xs">Indicadores clave (KPI)</span></span
			>
