<script lang="ts">
	...
	let { open, proposal, allKpis, onclose, onaccept, onreject }: Props =
		$props();
	...
	<div class="modal-box">
		...
		<div class="py-4 pb-0">
			<div class="mb-4 text-sm text-base-content/60">
				<p>
					Estado: <span class="badge badge-sm badge-warning">Pendiente</span>
				</p>
			</div>
			<GoalForm
				mode="readonly"
			...
			<div class="flex justify-end gap-2 mt-4">
				...
				>
				<button class="btn btn-sm btn-success" onclick={onaccept}
