...
<aside
	class="text-(--color-sidebar-content) bg-(--color-sidebar) h-full min-h-screen w-64 flex flex-col overflow-y-auto"
>
	...
	<div class="mb-4">
		...
		>
			<div class="min-w-0">
				...
				<p class="text-xs text-(--color-sidebar-content)/70 truncate">
					{user?.jobTitle}
				</p>
			</div>
		</a>
