...
export interface paths {
    ...
    "/employees/{empId}/hierarchical-score": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get the employee's hierarchical weighted score
         * @description Reutiliza ScoringService.GetEmployeeHierarchicalScore (personalHJ + global w·G + shared w·J·P, clamp 0-100; sin metas globales/compartidas P=100/PJ=100). cycleId opcional; scorer lee valores live.
         */
        get: operations["getEmployeeHierarchicalScore"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    getEmployeeHierarchicalScore: {
        ...
        requestBody?: never;
        responses: {
            /** @description Hierarchical weighted score */
            200: {
                headers: {
                    [name: string]: unknown;
                };
