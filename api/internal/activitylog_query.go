...
func (_q *ActivityLogQuery) QueryEmployee() *EmployeeQuery {
...
func (_q *ActivityLogQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ActivityLogQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *ActivityLogQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ActivityLogQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *ActivityLogQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *ActivityLogQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ActivityLogQuery) WithEmployee(opts ...func(*EmployeeQuery)) *ActivityLogQuery {
	query := (&EmployeeClient{config: _q.config}).Query()
...
func (_q *ActivityLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ActivityLog, error) {
	...
	if query := _q.withEmployee; query != nil {
		if err := _q.loadEmployee(ctx, query, nodes, nil,
			func(n *ActivityLog, e *Employee) { n.Edges.Employee = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ActivityLogQuery) loadEmployee(ctx context.Context, query *EmployeeQuery, nodes []*ActivityLog, init func(*ActivityLog), assign func(*ActivityLog, *Employee)) error {
...
func (_q *ActivityLogQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withEmployee != nil {
			_spec.Node.AddColumnOnce(activitylog.FieldEmployeeID)
		}
	}
