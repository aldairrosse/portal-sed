...
type OrganizationEdges struct {
	// OrgNodes holds the value of the org_nodes edge.
	OrgNodes []*OrgNode `json:"org_nodes,omitempty"`
...
// OrgNodesOrErr returns the OrgNodes value or an error if the edge
// was not loaded in eager-loading.
func (e OrganizationEdges) OrgNodesOrErr() ([]*OrgNode, error) {
	if e.loadedTypes[0] {
		return e.OrgNodes, nil
	}
	return nil, &NotLoadedError{edge: "org_nodes"}
}

// CyclesOrErr returns the Cycles value or an error if the edge
// was not loaded in eager-loading.
func (e OrganizationEdges) CyclesOrErr() ([]*Cycle, error) {
	if e.loadedTypes[1] {
		return e.Cycles, nil
	}
...
// QueryOrgNodes queries the "org_nodes" edge of the Organization entity.
func (_m *Organization) QueryOrgNodes() *OrgNodeQuery {
	return NewOrganizationClient(_m.config).QueryOrgNodes(_m)
}

// QueryCycles queries the "cycles" edge of the Organization entity.
func (_m *Organization) QueryCycles() *CycleQuery {
	return NewOrganizationClient(_m.config).QueryCycles(_m)
}
...
func (_m *Organization) Unwrap() *Organization {
	...
	if !ok {
		panic("internal: Organization is not a transactional entity")
	}
