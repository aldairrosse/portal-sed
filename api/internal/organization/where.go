...
func HasOrgNodes() predicate.Organization {
...
// HasOrgNodesWith applies the HasEdge predicate on the "org_nodes" edge with a given conditions (other predicates).
func HasOrgNodesWith(preds ...predicate.OrgNode) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := newOrgNodesStep()
...
// HasCycles applies the HasEdge predicate on the "cycles" edge.
func HasCycles() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasCyclesWith applies the HasEdge predicate on the "cycles" edge with a given conditions (other predicates).
func HasCyclesWith(preds ...predicate.Cycle) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := newCyclesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
