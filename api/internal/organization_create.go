...
func (_c *OrganizationCreate) AddOrgNodeIDs(ids ...uuid.UUID) *OrganizationCreate {
	_c.mutation.AddOrgNodeIDs(ids...)
	return _c
}

// AddOrgNodes adds the "org_nodes" edges to the OrgNode entity.
func (_c *OrganizationCreate) AddOrgNodes(v ...*OrgNode) *OrganizationCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddOrgNodeIDs(ids...)
}

// AddCycleIDs adds the "cycles" edge to the Cycle entity by IDs.
func (_c *OrganizationCreate) AddCycleIDs(ids ...uuid.UUID) *OrganizationCreate {
	_c.mutation.AddCycleIDs(ids...)
	return _c
}

// AddCycles adds the "cycles" edges to the Cycle entity.
func (_c *OrganizationCreate) AddCycles(v ...*Cycle) *OrganizationCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *OrganizationCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`internal: missing required field "Organization.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`internal: missing required field "Organization.updated_at"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`internal: missing required field "Organization.name"`)}
	}
	...
	if _, ok := _c.mutation.Slug(); !ok {
		return &ValidationError{Name: "slug", err: errors.New(`internal: missing required field "Organization.slug"`)}
	}
